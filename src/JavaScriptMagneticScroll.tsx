...
import './JavaScriptMagneticScroll.css';

const JavaScriptMagneticScroll: React.FC = () => {
  ...
  return (
    <div className="js-magnetic-container" ref={containerRef}>
      <div className="js-debug-panel">
        <h3>JavaScript Magnetic Scroll</h3>
        <div className="js-debug-info">
      ...
      <div className="js-center-line"></div>

      <div className="js-spacer"></div>

      {[1, 2, 3, 4, 5].map((num) => (
        <div key={num} className="js-snap-item">
          <div className="js-content">
            <h2>JavaScript Item {num}</h2>
            <p>Magnetic snapping with pure JavaScript</p>
...
export default JavaScriptMagneticScroll;