...
- **[Ask State Flow Architecture](./.claude/architecture/ask-state-flow-architecture.md)** - xState-based ask flow pattern
  - Event-driven architecture principles
  - Complete state machine flow with all transitions
  - Orchestrator vs machine responsibilities
  - AI integration with module-level storage
  - Migration guide for converting other flows to this pattern
